return {
    ...
    pauseMapText = 'Lone Star Roleplay', -- Text shown above the map when ESC is pressed. If left empty 'FiveM' will appear
    ...
    discord = {
        ...
        appId = '1273174815595040852', -- This is the Application ID (Replace this with you own)
